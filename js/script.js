...
//         while (target.getAttribute(self.options.items.attribute) == undefined || target == self.nav) target = target.parentNode;
//       }
...
//         submenu.style.top = item.scrollHeight + "px";
...
//       let self = this;
//       if (self.active) self.active.querySelector(self.options.submenu.selector).classList.remove(self.options.submenu.show);
...
//   new HorizontalNav("#horizontal-scroll");
// })(window);
